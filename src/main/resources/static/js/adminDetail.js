		...
		success: function(data) {
			...
			$(data.comments).each(function() {
				...
				if (this.commentDepth == 0) {
					...
					str += "</div>"
						// Post Recomment
						+ "<a class='text-right col-12 my-3' id='postReCommentBox'><span class='fw-bold' id='postReCommentBoxBtn' onclick='clickPostReComment(" + this.commentId + ", \"" + this.userNickname + "\")'>댓글달기</span></a>"
						// Delete Comment Btn
						...
						+ "<div class='reCommentIdAll' id='reCommentId" + this.commentId + "'></div>";
