	...
	<div class="container-md border px-5 pt-4" id=updateFormBox>
		<form action="/detail/updateMyDetail" method="post" id="updateForm">
	        <div class="form-group mb-5">
	            ...
	            <input type="text" class="form-control" placeholder="제목" name="updateTitle" maxlength="50" id="updateTitle" value="${board.myBoardTitle }">
	        </div>
	        <div class="form-group">
	        	<label for="ckeditor" class="my-2 fw-bold" id="ckeditorLabel">내용</label>
	            <textarea class="form-control my-3" placeholder="내용" name="updateContent" maxlength="2048" style="height:350px" id="ckeditor">${board.myBoardContent }</textarea>
			</div>
			<input type="hidden" id="id" name="id" value="${board.myBoardId }">
			<div class="row my-5">
				<div class="col-6" id="goToList"><a href="/board/myOwnBoard"><i class="fa fa-solid fa-list fa-2x"></i></a></div>
