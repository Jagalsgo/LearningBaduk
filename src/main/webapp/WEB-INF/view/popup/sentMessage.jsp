...
<div class="cotainer-fluid popupHeader">보낸 쪽지함</div>
<div class="headerItem mb-4" id="headerList">
	<div class="container-fluid py-3">
		...
		</span> <span class="fw-bold mb-2 mx-3"> <a href="${pageContext.request.contextPath }/popup/sentMessage"
			...
			<tbody>
				<c:forEach var="m" items="${messages }">
					<tr class="messages">
						...
						<td class="fw-bold"><a
							href="/popup/sentMessageDetail?id=${m.messageId }&p=${param.p}">${m.messageTitle}</a></td>
						<td class="boardWriter text-center"><span
							class="userMenuPointer userMenuClick"
							onclick="openUserMenu(${m.messageId}, '${m.receiver }')">${m.receiverNickname}
	...
	<form class="search-form">
		<fieldset>
			<select class="form-select-sm" name="f" style="width: 80px;">
				...
				<option ${param.f == "receiverNickname"?"selected":"" } value="receiverNickname">받은
					사람</option>
